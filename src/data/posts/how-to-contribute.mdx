---
title: How to Contribute to UniswapHooks
description: It can be daunting contributing to an open source project, find out how you can get involved with the development of UniswapHooks.
date: 07/25/2022
emoji: 🫵
---

For some, the idea of contributing to an open source project can be very daunting but please don't let that put you off. Let's walk through how you can contribute to UniswapHooks and get some open source work on your CV/GitHub.
...
If you have something that you want to add to UniswapHooks then that's awesome, but before you dive too deep into the development, I'd recommend that you [create an issue](https://github.com/markmead/hyperui/issues/new/choose) to outline what it is that you are adding.
...
All pull requests need to be reviewed before being merged into UniswapHooks, which does mean that on occasion there will be feedback. Please do not be disheartened by feedback, we're all developing each other's skill set and trying to make UniswapHooks (and other open source projects) better.

### Getting UniswapHooks Running Locally

UniswapHooks is a Next JS + Typescript project and can be set up quickly with the following commands.
...
If you are looking to add a component to UniswapHooks then I will give feedback on both the design and development of the component.
...
Contributing to open source is one of the best feelings for a developer, but as mentioned, it can be very daunting. I really don't want anyone to feel that way with UniswapHooks, so please do get involved, and let's all push UniswapHooks to become a better project.
