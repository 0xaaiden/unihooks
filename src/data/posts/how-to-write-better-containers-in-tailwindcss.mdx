...
Throughout UniswapHooks you will see the classes `max-w-screen-xl mx-auto px-4` used to contain content, this can be seen on the website and the components.
